...
class RemoveDuplicatesII082 {
     ...
     *    - 如果相同，说明 prev.next 的值是重复值，记录这个值 dupVal，
     *      然后一直跳过所有值等于 dupVal 的节点。
     ...
     *   prev=2:
     *     prev.next=3, prev.next.next=3, 3==3 → dupVal=3
     *     跳过所有3 → prev.next=4
     *   prev=2:
     *     prev.next=4, prev.next.next=4, 4==4 → dupVal=4
     *     跳过所有4 → prev.next=5
     *   prev=2:
