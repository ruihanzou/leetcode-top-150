...
class Solution:
    ...
    【空间复杂度】O(n) —— 两个堆的总空间
    """
    def findMaximizedCapital_two_heaps(self, k: int, w: int, profits: List[int], capital: List[int]) -> int:
    ...
    【空间复杂度】O(n) —— 最大堆空间
    """
    def findMaximizedCapital_sort_heap(self, k: int, w: int, profits: List[int], capital: List[int]) -> int:
