...
class Solution:
    ...
    【举例】k=2, prices = [3,2,6,5,0,3]
      ...
      day 3 (5): dp[1]=[4,-2], dp[2]=[4,-1]
      day 4 (0): dp[1]=[4,0], dp[2]=[4,4]
      day 5 (3): dp[1]=[4,0], dp[2]=[7,4]
      答案 dp[2][0] = 7
    ...
    【空间复杂度】O(min(k, n/2))
    """
    def maxProfit_v2(self, k: int, prices: List[int]) -> int:
        n = len(prices)
        if n <= 1 or k == 0:
            return 0
